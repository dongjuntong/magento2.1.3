 ...
 * @method Post setProductImage($productImage)
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'sanv_banner_post';
     ...
     * @var string
     */
    protected $_cacheTag = 'sanv_banner_post';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sanv_banner_post';
    ...
    {
        $this->_init('Sanv\Banner\Model\ResourceModel\Post');
    }
